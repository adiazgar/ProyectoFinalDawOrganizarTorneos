<%-- 
    Document   : mostrarTorneoIndividual
    Created on : 03-jun-2019, 20:53:49
...
<% Torneo tor = (Torneo) request.getAttribute("tor");
    ...
    <div class="row text-center">
        ...
        <div class="col-md-12 col-lg-12 col-sm-12" style="margin-top: 2%;">
            ...
            <div class="col-md-12 col-lg-12 col-sm-12" style="color: white; margin: 2% 0;"><h1>Torneo: <%=tor.getNombreTorneo() %> </h1></div>
