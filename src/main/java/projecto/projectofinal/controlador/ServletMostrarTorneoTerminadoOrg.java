 ...
 */
public class ServletMostrarTorneoTerminadoOrg extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String nombreTorneoT = (String) request.getParameter("torneo");
        
        Torneo tor = buscarTorneo(nombreTorneoT);
            ...
            request.setAttribute("action", "mostrarTorneoIndividualTerminado");
